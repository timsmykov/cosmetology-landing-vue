  ...
  window.Landing.content.program = {
    ...
    webinars: [
      ...
      },
      {
        ...
        learn: [
          'Создадите цифрового двойника за 1 день.',
      ...
      },
      {
        ...
        text: 'Финальный элемент: как связать посты/Reels/аватар с записью, не терять лидов в директ, использовать ИИ-скрипты ответов и понимать, что реально работает.',
        learn: [
          'Собрать Instagram-воронку: контент → CTA → директ → запись.',
          'Использовать ИИ-скрипты и ответы в директ.',
